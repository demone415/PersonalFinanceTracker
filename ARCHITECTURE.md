...
- [ ] T1.4.2 CRUD эндпоинты /api/v1/accruals с пагинацией и FluentValidation
- [ ] T1.4.3 Поддержка тегов и GroupId
- [ ] T1.4.4 ChangeLog EF Interceptor (значения до/после в JSON)
- [ ] T1.4.5 Список начислений с пагинацией, скелетон-загрузка
- [ ] T1.4.6 Форма создания/редактирования начисления (оптимистичные обновления)
- [ ] T1.4.7 Ручное добавление позиций чека к начислению
...
- [ ] T7.1.1 GET /changelog с пагинацией и фильтром по entityType
- [ ] T7.1.2 Страница журнала изменений
