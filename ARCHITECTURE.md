...
- [x] T6.1.3 Сущность `BackgroundTask` (статус/прогресс) + GET /jobs/{id} — реализовано вместе со Story 6.2 (общая инфраструктура задач); импорт (6.1.1/6.1.2/6.1.4) ещё не сделан
